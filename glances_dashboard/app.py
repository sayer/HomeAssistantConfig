...
SSH_SNIPPET_PATH = SSH_DIR / "glances-dashboard"
...
def _sync_update_aliases(entries: List[Dict[str, Any]]) -> None:
    ...
    lines: List[str] = [
        "# Autogenerated by Glances Fleet Dashboard. Do not edit.",
...
def _ensure_ssh_include_directive() -> None:
    """Ensure ~/.ssh/config includes the glances alias snippet."""
    try:
        SSH_DIR.mkdir(mode=0o700, exist_ok=True)
    except OSError:
        return
